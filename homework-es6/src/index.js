...
let r1 = new Request('GET', 'http://localhost:51980/admin/api/settings/values/portal/portal/theme?token=6e0ef64bb581e9f26673a8913f9359641a47b77a468928efe0035f528ab670cd');
r1.addHeader('Accept', '*/*');
r1.send().then((result) => {
